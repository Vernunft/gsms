...
interface Function {
    ...
    /**
      ...
      * @param value The object to itemTitle.
      */
...
interface Math {
    ...
    /**
      ...
      * @param x The numeric expression to itemTitle
      */
...
interface ObjectConstructor {
    ...
    */
    ...
    /**
      ...
      * @param attributes Descriptor for the property. It can be for a dataList property or an accessor
      *  property.
      */
...
interface ArrayConstructor {
    ...
    /**
      * Determines whether all the members of an array satisfy the specified itemTitle.
