...
var totalChartComponent = (function () {
    function totalChartComponent(dataListService) {
    ...
    totalChartComponent.prototype.ngOnInit = function () {
        var _this = this;
        setInterval(function () {
            _this.getAll();
        }, 10000);
    };
    totalChartComponent.prototype.getAll = function () {
        var _this = this;
        this.dataListService
            .getAll()
            .then(function (dataList) {
            _this.dataList = dataList;
            _this.totalChart = makeChart({
    ...
    return totalChartComponent;
}());
totalChartComponent = __decorate([
    core_1.Component({
...
exports.totalChartComponent = totalChartComponent;
